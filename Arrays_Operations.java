...
/** here we can learn about passing array as argument & return arr in method
 * search an element in array using if-else and binarysearch
 */
import java.util.*;
...
public class Arrays_Operations {
    public static void main(String[] args) {
        ...
        // System.out.println("Searching an element of an array using Binary Search : "
        // + Arrays.binarySearch(arr, 76));
        /*
         * int arraytwo[] =
